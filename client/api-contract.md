...
- Response Shape: Returns updated Agent object
...
- Description: Update an existing folder's details (name, parent_id, level)
- Request Body:
```json
{
  "name": "String",
...
```
- Response Shape: Returns updated Folder object
- Error Codes: 400, 404, 500
- Auth Required: No
